...
sigmaA= 6.9+6.9 ;  % 0 -6.9   6.9+6.9+6.9   ; -5.9  5.9+5.9+5.9;
KpskillTHresHold=1.5;
...
if inputString=='ev03'
  ...
  ftsStr='fig/AIAfts/event03_20120310_023749_AIA_171_.fts';
%    info=fitsinfo ('fig/AIAfts/event03_20120310_023749_AIA_171_.fts');
%    Im2 =fitsread ('fig/AIAfts/event03_20120310_023749_AIA_171_.fts');
      insit_path='fig/Insitu/Omni/E03_Omni.txt';    % Bestimate
...
% - Enlil Velocity        NewMKpEst=[4.95,8.38];  %  DEFAULT  --  NewMKpmax=8.6; NewMKpmin=6.8; comes from varying sd |B| estimates
        ...
        %KpskillMANFUDGE=1;
        KpskillMANFUDGE=-3;
        KpskillTHresH=KpskillTHresHold;
...
elseif inputString=='ev04'
  ...
  ftsStr='fig/AIAfts/event04_20120614_115501_AIA_171_.fts';
...
%    Im2 =fitsread ('fig/AIAfts/event04_20120614_115501_AIA_171_.fts');
      insit_path='fig/Insitu/Omni/E04_Omni.txt';    
      T1=datenum([2012,06,15,18,00,00]);
      T2=datenum([2012,06,16,06,00,00]);
        ccmcKpEst=[5.0, 9.0];
        swpcKpEst=[4.0, 5.0];         % verified                      
...
elseif inputString=='ev05'
  ...
  ftsStr='fig/AIAfts/event05_20120712_163824_AIA_171_.fts';
...
%    Im2 =fitsread ('fig/AIAfts/event05_20120712_163824_AIA_171_.fts');
    insit_path='fig/Insitu/Omni/E05_Omni.txt';    
...
elseif inputString=='ev08'                     %  e08
  ...
  ftsStr='fig/AIAfts/event08_20120613_155801_AIA_171_.fts';
...
%    Im2 =fitsread ('fig/AIAfts/event08_20120613_155801_AIA_171_.fts');
    insit_path='fig/Insitu/Omni/E08_Omni.txt';    
...
elseif inputString=='ev09'
  ...
  ftsStr='fig/AIAfts/event09_20120928_020336_AIA_171_.fts';
...
%    Im2 =fitsread ('fig/AIAfts/event09_20120928_020336_AIA_171_.fts');
      insit_path='fig/Insitu/Omni/E09_Omni.txt';  
...
elseif inputString=='ev10'
  so= [-30.75,30.46];      % [-30.75,30.46]; [lat, lon]= [-16.845,46.7612];  [-4.1,8.0];
  I_tilt=40.25;        % 40.25 ; 60.25
  I_haf=41.93;
  I_Mgram='South';
  cycle=23;
...
ftsStr='fig/AIAfts/event10_20140107_201400_AIA_171_.fts';
...
%    Im2 =fitsread ('fig/AIAfts/event10_20140107_201400_AIA_171_.fts');
      insit_path='fig/Insitu/Omni/E10_Omni.txt';  % Bestimate
...
elseif inputString=='ev11'
  ...
  ftsStr='fig/AIAfts/event11_20110325_004425_AIA_171_.fts';
...
%    Im2 =fitsread ('fig/AIAfts/event11_20110325_004425_AIA_171_.fts');
      insit_path='fig/Insitu/Omni/E11_Omni.txt';  
...
elseif inputString=='ev12'
  ...
  ftsStr='fig/AIAfts/event12_20100527_061100_AIA_171_.fts';
...
%    Im2 =fitsread ('fig/AIAfts/event12_20100527_061100_AIA_171_.fts');
      insit_path='fig/Insitu/Omni/E12_Omni.txt';  
...
elseif inputString=='ev13'
  ...
  %StrucFRax.stTime=datenum([2014,01,10,02,00,00]);  % st n end of FR time series e10 late version
  %StrucFRax.enTime=datenum([2014,01,11,01,00,00]);
  ftsStr='fig/AIAfts/event13_20140910_175112_AIA_171_.fts';
...
%    Im2 =fitsread ('fig/AIAfts/event13_20140910_175112_AIA_171_.fts');
      insit_path='fig/Insitu/Omni/E13_Omni.txt';  % Bestimate
      T1=datenum([2014,09,11,12,00,00]);  % time range used only for estimating the background static in situ params.
      T2=datenum([2014,09,11,18,00,00]);
        ccmcKpEst=[6.0, 8.0];   % KpIndexplot4
        swpcKpEst=[5.9, 7.1];  % verified
